...
var sequel = 'The Dark Forest';
console.log(`${sequel} is the sequel to ${title}.`);
...
var books = ['Sirens of Titan', 'Breakfast of Champions', 'Slaughterhouse Five', 'Player Piano', 'Cat\'s Cradle'];
